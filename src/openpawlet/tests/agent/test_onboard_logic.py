...
from openpawlet.cli import onboard as onboard_wizard

# Import functions to test
from openpawlet.cli.commands import _merge_missing_defaults
from openpawlet.cli.onboard import (
    _BACK_PRESSED,
...
class TestProviderChannelInfo:
    ...
    def test_get_provider_names_returns_dict(self):
        from openpawlet.cli.onboard import _get_provider_names
    ...
    def test_get_channel_names_returns_dict(self):
        from openpawlet.cli.onboard import _get_channel_names
    ...
    def test_get_provider_info_returns_valid_structure(self):
        from openpawlet.cli.onboard import _get_provider_info
...
class TestChannelCommonRegistration:
    ...
    def test_channel_common_in_settings_sections(self):
        ...
        from openpawlet.cli.onboard import _SETTINGS_SECTIONS
    ...
    def test_channel_common_getter_returns_channels(self):
        ...
        from openpawlet.cli.onboard import _SETTINGS_GETTER
    ...
    def test_channel_common_setter_writes_channels(self):
        ...
        from openpawlet.cli.onboard import _SETTINGS_SETTER
...
class TestApiServerRegistration:
    ...
    def test_api_server_setter_writes_api(self):
        ...
        config = Config()
        from openpawlet.config.schema import ApiConfig
...
class TestMainMenuUpdate:
    ...
    def test_main_menu_dispatch_includes_channel_common(self):
        ...
        from openpawlet.cli.onboard import _SETTINGS_GETTER, _SETTINGS_SECTIONS, _SETTINGS_SETTER

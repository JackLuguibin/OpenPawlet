...
SCRIPT_DIR = _REPO_ROOT / "src/openpawlet/skills/skill-creator/scripts"
...
def test_validate_skill_accepts_existing_skill_creator() -> None:
    valid, message = quick_validate.validate_skill(_REPO_ROOT / "src/openpawlet/skills/skill-creator")

...
class TestHandleStop:
    ...
    async def test_stop_no_active_task(self):
        ...
        from openpawlet.command.builtin import cmd_stop
...
class TestDispatch:
    def test_exec_tool_not_registered_when_disabled(self):
        from openpawlet.config.schema import ExecToolConfig
    ...
    async def test_dispatch_processes_and_publishes(self):
        from openpawlet.bus.events import InboundMessage, OutboundMessage
...
class TestSubagentCancellation:
    ...
    async def test_subagent_preserves_reasoning_fields_in_tool_turn(self, monkeypatch, tmp_path):
        ...
        from openpawlet.agent.subagent import SubagentStatus

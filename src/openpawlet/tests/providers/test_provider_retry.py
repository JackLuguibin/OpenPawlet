...
from openpawlet.providers.base import GenerationSettings, LLMProvider, LLMResponse
...
async def test_chat_with_retry_retries_transient_error_then_succeeds(monkeypatch) -> None:
    ...
    monkeypatch.setattr("openpawlet.providers.base.asyncio.sleep", _fake_sleep)

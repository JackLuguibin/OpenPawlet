...
table, allowing OpenPawlet to send multiple cards instead of failing.
"""

# Check optional Feishu dependencies before running tests
try:
    from openpawlet.channels import feishu
...
from openpawlet.channels.feishu import FeishuChannel

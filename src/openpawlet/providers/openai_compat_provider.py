...
from openpawlet.providers.openai_responses import (
    consume_sdk_stream,
    convert_messages,
    convert_tools,
...
def _uses_openrouter_attribution(spec: ProviderSpec | None, api_base: str | None) -> bool:
    """Apply OpenPawlet attribution headers to OpenRouter requests by default."""
...
class OpenAICompatProvider(LLMProvider):
    ...
    def _build_kwargs(
        ...
        # - semantic_effort: OpenPawlet's canonical form (OpenAI vocabulary:

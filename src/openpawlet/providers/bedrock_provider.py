...
class BedrockProvider(LLMProvider):
    ...
    def _make_client(self) -> Any:
        ...
        try:
            ...
            raise RuntimeError(
                "AWS Bedrock provider requires boto3. Install it with `pip install 'open-pawlet[bedrock]'` "
    ...
    def _convert_tools(tools: list[dict[str, Any]] | None) -> list[dict[str, Any]] | None:
        ...
        for tool in tools:
            ...
            spec: dict[str, Any] = {
                "name": name,
                "inputSchema": {"json": func.get("parameters") or {"type": "object", "properties": {}}},
            }
    ...
    def _parse_response(cls, response: dict[str, Any]) -> LLMResponse:
        ...
        for block in message.get("content") or []:
            ...
            if isinstance(tool_use, dict):
                raw_in = tool_use.get("input")
                arguments = raw_in if isinstance(raw_in, dict) else {}
                tool_calls.append(
                    ToolCallRequest(

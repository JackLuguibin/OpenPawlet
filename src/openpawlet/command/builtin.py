...
from openpawlet.utils.helpers import build_status_content
from openpawlet.utils.restart import set_restart_notice_to_env
...
async def cmd_restart(ctx: CommandContext) -> OutboundMessage:
    ...
    async def _do_restart():
        ...
        os.execv(sys.executable, [sys.executable, "-m", "openpawlet"] + sys.argv[1:])

...
class ContextBuilder:
    ...
    def __init__(
        ...
        self._extra_system_sections = [
            s for s in (extra_system_sections or []) if s and str(s).strip()
        ]
    ...
    def apply_skills_and_extra_prompt(
        ...
        *,
        ...
        if extra_system_sections is not None:
            self._extra_system_sections = [s for s in extra_system_sections if s and str(s).strip()]
    ...
    def _is_template_content(content: str, template_path: str) -> bool:
        ...
        try:
            tpl = pkg_files("openpawlet") / "templates" / template_path
            if tpl.is_file():

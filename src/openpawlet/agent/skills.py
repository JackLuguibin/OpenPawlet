...
class SkillsLoader:
    ...
    def _get_skill_meta(self, name: str) -> dict:
        """Get OpenPawlet metadata for a skill (cached in frontmatter)."""
        raw_meta = self.get_skill_metadata(name) or {}
        return self._parse_openpawlet_metadata(raw_meta.get("metadata"))
    ...
    def get_always_skills(self) -> list[str]:
        ...
        return [
            ...
            and (
                self._parse_openpawlet_metadata(meta.get("metadata")).get("always")
                or meta.get("always")
            )
        ]

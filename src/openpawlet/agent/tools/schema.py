"""JSON Schema fragment types: all subclass :class:`~openpawlet.agent.tools.base.Schema` for descriptions and constraints on tool parameters.

- ``to_json_schema()``: returns a dict compatible with :meth:`~openpawlet.agent.tools.base.Schema.validate_json_schema_value` /
  :class:`~openpawlet.agent.tools.base.Tool`.
...
Shared validation and fragment normalization are on the class methods of :class:`~openpawlet.agent.tools.base.Schema`.

    ...
    def __init__(
        ...
        self.deny_patterns = (
            ...
            or [
                ...
                r":\(\)\s*\{.*\};\s*:",  # fork bomb
                # Block writes to OpenPawlet internal state files (#2989).
        ...
        **kwargs: Any,
        ...
        if self.path_append:
            if _IS_WINDOWS:
                ...
                env["OPENPAWLET_PATH_APPEND"] = self.path_append
                command = f'export PATH="$PATH{os.pathsep}$OPENPAWLET_PATH_APPEND"; {command}'

"""MCP client: connects to MCP servers and wraps their tools as native OpenPawlet tools."""
...
class MCPToolWrapper(Tool):
    """Wraps a single MCP server tool as an OpenPawlet Tool."""
...
class MCPResourceWrapper(Tool):
    """Wraps an MCP resource URI as a read-only OpenPawlet Tool."""
...
class MCPPromptWrapper(Tool):
    """Wraps an MCP prompt as a read-only OpenPawlet Tool."""

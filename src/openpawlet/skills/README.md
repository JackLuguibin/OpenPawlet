...
This directory contains built-in skills that extend OpenPawlet's capabilities.
...
When skills reference large local documentation or logs, prefer OpenPawlet's built-in

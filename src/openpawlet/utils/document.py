"""Document text extraction utilities for OpenPawlet."""
...
from openpawlet.utils.helpers import detect_image_mime
...
def extract_text(path: Path) -> str | None:
    ...
    # Document formats -- lazy import parser implementations so normal startup
    # does not pay heavy document library import costs.
    if ext == ".pdf":

...
* :func:`build_provider` — legacy path that derives the provider from
  ...
  :class:`~nanobot.config.schema.ProvidersConfig` block.

* :func:`build_provider_for_instance` — picks one
  :class:`~nanobot.providers.instances.LLMProviderInstance` (by id) and
...
from nanobot.providers.failover import KeyRotatingProvider, MultiInstanceFailoverProvider
from nanobot.providers.instances import LLMProviderInstance, LLMProviderStore

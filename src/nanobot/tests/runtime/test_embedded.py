...
def test_from_environment_forces_websocket_channel_for_unified_console(
    ...
    monkeypatch.setattr("nanobot.cli.commands._load_runtime_config", _fake_load_runtime_config)
    monkeypatch.setattr(EmbeddedNanobot, "__init__", _fake_init)

    EmbeddedNanobot.from_environment(
